Ext.define('Modules.files.js.music.playlist.Item', {
	...
	initDragDrop: function(){
		var drag = Ext.create('Modules.files.js.dd.DragItem', this.el.id);
		var drop = Ext.create('Modules.files.js.dd.DropItem', this.el.id);
