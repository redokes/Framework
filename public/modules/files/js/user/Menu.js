Ext.define('Modules.files.js.user.Menu', {
	...
	initFolderSelect: function(){
		this.folder = Ext.create('Modules.files.js.form.field.Folder', {
			scope: this,
			fieldLabel: 'Share',
			labelWidth: 70
		});
	...
	initFolderView: function(){
		this.folderView = Ext.create('Modules.files.js.user.view.Folders', {
			scope: this
		});
